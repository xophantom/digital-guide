...
export function buildChatPrompt(property: Property): string {
  return [
    ...
    `- Para restaurantes, atrações ou serviços próximos, chame getNearbyPlaces. Se ela indicar que o guia está sendo preparado, avise o hóspede para tentar em instantes.`,
