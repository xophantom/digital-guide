    ...
    <div className="fixed inset-0 z-30 flex flex-col overflow-hidden bg-card shadow-2xl sm:inset-auto sm:right-5 sm:bottom-5 sm:h-[620px] sm:max-h-[calc(100vh-2.5rem)] sm:w-96 sm:rounded-2xl sm:border sm:border-line">
      ...
      >
        ...
        {error ? (
          <div
            role="alert"
            className="rounded-2xl bg-red-50 px-3 py-2.5 text-sm text-red-800"
          >
            <p>Ops, não consegui responder agora.</p>
            <button
              type="button"
              onClick={() => regenerate()}
              className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-red-100 px-3 py-1 text-xs font-semibold text-red-800 transition-colors hover:bg-red-200"
            >
